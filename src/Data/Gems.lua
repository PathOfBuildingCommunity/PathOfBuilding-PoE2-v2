...
return {
	...
	["Metadata/Items/Gems/SkillGemLightningWarp"] = {
		...
		gemType = "Spell",
		tagString = "AoE, Lightning, Duration",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		Tier = 9,
	...
	["Metadata/Items/Gems/SkillGemFirestorm"] = {
		...
		gemType = "Spell",
		tagString = "AoE, Sustained, Fire, Duration, Payoff",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		Tier = 11,
	...
	["Metadata/Items/Gems/SkillGemLightningArrow"] = {
		...
		gemType = "Attack",
		tagString = "AoE, Projectile, Lightning, Chaining",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		Tier = 1,
	...
	["Metadata/Items/Gems/SkillGemArcticArmour"] = {
		...
		gemType = "Buff",
		tagString = "Spell, Persistent, Sustained, Cold",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		Tier = 4,
	...
	["Metadata/Items/Gems/SkillGemFlameblast"] = {
		...
		gemType = "Spell",
		tagString = "AoE, Fire, Channelling, Nova",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		Tier = 13,
	...
	["Metadata/Items/Gems/SkillGemArtilleryBallista"] = {
		...
		gemType = "Attack",
		tagString = "Totem, AoE, Projectile, Fire, Duration",
		reqStr = 50,
		reqDex = 50,
		reqInt = 0,
		Tier = 9,
	...
	["Metadata/Items/Gems/SkillGemLightningConduit"] = {
		...
		gemType = "Spell",
		tagString = "AoE, Lightning, Payoff",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		Tier = 13,
	...
	["Metadata/Items/Gems/SkillGemSuperchargedSlam"] = {
		...
		gemType = "Attack",
		tagString = "AoE, Melee, Slam, Channelling",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		Tier = 11,
	...
	["Metadata/Items/Gems/SkillGemWaveOfFrost"] = {
		...
		gemType = "Movement",
		tagString = "Attack, AoE, Melee, Cold",
		reqStr = 0,
		reqDex = 50,
		reqInt = 50,
		Tier = 7,
	...
	["Metadata/Items/Gems/SkillGemRipwireBallista"] = {
		...
		gemType = "Attack",
		tagString = "Totem, Projectile, Duration",
		reqStr = 50,
		reqDex = 50,
		reqInt = 0,
		Tier = 7,
	...
	["Metadata/Items/Gems/SkillGemExplosiveGrenade"] = {
		...
		gemType = "Attack",
		tagString = "AoE, Projectile, Grenade, Fire, Duration, Detonator",
		reqStr = 50,
		reqDex = 50,
		reqInt = 0,
		Tier = 1,
	...
	["Metadata/Items/Gems/SkillGemFlashGrenade"] = {
		...
		gemType = "Attack",
		tagString = "AoE, Projectile, Grenade, Duration",
		reqStr = 50,
		reqDex = 50,
		reqInt = 0,
		Tier = 3,
	...
	["Metadata/Items/Gems/SkillGemStaggeringPalm"] = {
		...
		gemType = "Attack",
		tagString = "AoE, Melee, Strike, Projectile, Physical, Duration",
		reqStr = 0,
		reqDex = 50,
		reqInt = 50,
		Tier = 3,
	...
	["Metadata/Items/Gems/SkillGemChargedStaff"] = {
		...
		gemType = "Spell",
		tagString = "Attack, Buff, AoE, Duration",
		reqStr = 0,
		reqDex = 50,
		reqInt = 50,
		Tier = 9,
	...
	["Metadata/Items/Gems/SkillGemTempestBell"] = {
		...
		gemType = "Attack",
		tagString = "AoE, Melee, Sustained, Duration, Nova",
		reqStr = 0,
		reqDex = 50,
		reqInt = 50,
		Tier = 3,
	...
	["Metadata/Items/Gems/SkillGemBonestorm"] = {
		...
		gemType = "Spell",
		tagString = "AoE, Projectile, Sustained, Physical, Duration, Channelling",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		Tier = 5,
	...
	["Metadata/Items/Gems/SkillGemDetonatingArrow"] = {
		...
		gemType = "Attack",
		tagString = "AoE, Projectile, Fire, Channelling, Detonator",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		Tier = 9,
	...
	["Metadata/Items/Gems/SkillGemPoisonBurstArrow"] = {
		...
		gemType = "Attack",
		tagString = "AoE, Projectile, Chaos, Duration",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		Tier = 1,
	...
	["Metadata/Items/Gems/SkillGemLightningRod"] = {
		...
		gemType = "Attack",
		tagString = "AoE, Projectile, Sustained, Lightning, Duration",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		Tier = 1,
	...
	["Metadata/Items/Gems/SkillGemSnipe"] = {
		...
		gemType = "Attack",
		tagString = "AoE, Projectile, Channelling",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		Tier = 3,
	...
	["Metadata/Items/Gems/SkillGemGasArrow"] = {
		...
		gemType = "Attack",
		tagString = "AoE, Projectile, Fire, Chaos, Duration",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		Tier = 7,
	...
	["Metadata/Items/Gems/SkillGemElementalDischarge"] = {
		...
		gemType = "Support",
		tagString = "Spell, Lightning, Cold, Fire, Payoff",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		Tier = 3,
	...
	["Metadata/Items/Gems/SkillGemWindDancer"] = {
		...
		gemType = "Buff",
		tagString = "Attack, Persistent, AoE, Melee",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		Tier = 4,
	...
	["Metadata/Items/Gems/SkillGemAscendancyUnboundAvatar"] = {
		...
		gemType = "Buff",
		tagString = "Lightning, Cold, Fire, Duration",
		reqStr = 0,
		reqDex = 0,
		reqInt = 0,
		Tier = 0,
	...
	["Metadata/Items/Gems/SkillGemShockchainArrow"] = {
		...
		gemType = "Attack",
		tagString = "AoE, Projectile, Lightning, Chaining, Payoff",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		Tier = 11,
	...
	["Metadata/Items/Gems/SkillGemFreezingMark"] = {
		...
		gemType = "Spell",
		tagString = "Attack, AoE, Mark, Cold, Duration, Nova",
		reqStr = 0,
		reqDex = 50,
		reqInt = 50,
		Tier = 7,
	...
	["Metadata/Items/Gems/SkillGemVoltaicMark"] = {
		...
		gemType = "Spell",
		tagString = "Attack, AoE, Mark, Lightning, Duration, Nova",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		Tier = 7,
	...
	["Metadata/Items/Gems/SkillGemTornadoShot"] = {
		...
		gemType = "Attack",
		tagString = "AoE, Projectile, Physical, Duration",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		Tier = 11,
	...
	["Metadata/Items/Gems/SkillGemWitheringPresence"] = {
		...
		gemType = "Buff",
		tagString = "Persistent, Chaos, Duration",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		Tier = 4,
	...
	["Metadata/Items/Gems/SkillGemGatheringStorm"] = {
		...
		gemType = "Attack",
		tagString = "AoE, Melee, Strike, Lightning, Channelling, Travel",
		reqStr = 0,
		reqDex = 50,
		reqInt = 50,
		Tier = 13,
